...
public static class Stores
{
    public static void CopyData(ref byte destination)
    {
        ...
        CopyBlockUnaligned(
            ref destination,
            in Unwrap.From(new byte[Length] { 0xFF, 0x5E, 0x30, 0x21, 0x44, 0x55, 0x55, 0x1A }),
            Length);
    }
    ...
    public static byte CopyDataAndReturn()
    {
        ...
        ref byte destination = ref Unwrap.From(stackalloc byte[Length]);
    ...
    public static byte CopyNativeDataAndReturn()
    {
        ...
        CopyBlockUnaligned(
            ref destination,
            in Unwrap.From(new byte[Length] { 0xFE, 0x5C, 0x75, 0x22, 0x34, 0x15, 0x5C, 0x1A }),
            Length);
        return destination;
    }
    ...
    public static byte CopyNativeDataAndReturn2(Span<byte> dest)
    {
        ...
        ref byte destination = ref Unwrap.From(dest);
        CopyBlockUnaligned(
            ref destination,
            in Unwrap.From(new byte[Length] { 0xFE, 0x5C, 0x75, 0x22, 0x34, 0x15, 0x5C, 0x1A }),
            Length);
    ...
    public static byte ShowData(ReadOnlySpan<byte> source) => Unwrap.From(source);
